        ...
        <div className="col-span-1 flex flex-col gap-6">
          ...
          <div className="bg-white shadow-lg rounded-2xl p-5 w-full">
            ...
            <div className="flex gap-4 mt-6">
              <button className="bg-blue-500 text-white px-6 py-2 rounded-full shadow-md hover:bg-blue-600 w-full">
                Archive
              </button>
              <button className="bg-yellow-500 text-white px-6 py-2 rounded-full shadow-md hover:bg-yellow-600 w-full">
                Update Status
              </button>
              <button className="bg-green-500 text-white px-6 py-2 rounded-full shadow-md hover:bg-green-600 w-full">
                Mark Complete
              </button>
            </div>
          </div>
